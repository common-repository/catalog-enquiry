...
Tags: woocommerce, woocommerce Catalog, woocommerce Enquiry
...
Woo Catalog Enquiry is a robust WordPress plugin that can help you to convert woo commerce store into a catalog. You can show any digital and analog product without showing the price. There are lots of customization option will be there.  Here are our some bold features"- 

<h3>Include features</h3>

*   Hide price from shop page
*   Hide price from single product
*   Hide cart button from shop page
*   Hide cart button from single product
*   Add enquiry form on single product
*   You can use unlimited fields in enquiry form
*   You can use custom css
*   You can change button color & background color
*   Fully customizable
